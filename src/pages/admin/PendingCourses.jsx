        ...
        {PENDING_COURSES.map((c, i) => (
          ...
          >
            ...
            <div className="flex gap-2">
              <button className="w-8 h-8 rounded-lg bg-emerald-500 text-white flex items-center justify-center text-xs hover:bg-emerald-600 transition-colors">
                ✓
              </button>
              <button className="w-8 h-8 rounded-lg bg-slate-200 text-slate-600 flex items-center justify-center text-xs hover:bg-red-500 hover:text-white transition-all">
                ✕
              </button>
            </div>
          </div>
