      ...
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex-1">
            ...
            {/* Last lesson */}
            <p className="text-white/70 text-xs mb-4 flex items-center gap-2">
          ...
          <div className="flex flex-col items-start md:items-center gap-3 shrink-0">
            ...
            <button className="flex items-center gap-2 bg-white text-primary font-black text-sm px-8 py-3 rounded-xl hover:shadow-xl hover:-translate-y-0.5 transition-all">
              <FiPlay />
              Resume Course
            </button>
          ...
          <div className="divide-y divide-gray-50">
            ...
            {[
              ...
              >
                ...
                {/* Action */}
                {!lesson.locked && (
                  <button className="flex items-center gap-1.5 shrink-0 text-xs font-bold text-primary border border-primary/30 px-3 py-1.5 rounded-lg hover:bg-violet-50 transition-all">
