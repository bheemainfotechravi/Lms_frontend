...
import {
  ...
  BarChart3,
  PenTool,
  Package, // use instead of "Container"
} from "lucide-react";
...
export const LEADERBOARD = [
  { rank: 1, name: "Ritika Joshi", avatar: "RJ", points: 4820, medal: "gold", highlight: false },
  { rank: 2, name: "Sameer Khanna", avatar: "SK", points: 4310, medal: "silver", highlight: false },
  { rank: 3, name: "You", avatar: "ME", points: 3975, medal: "bronze", highlight: true },
  { rank: 4, name: "Anika Patel", avatar: "AP", points: 3640, medal: null, highlight: false },
  { rank: 5, name: "Rahul Mehta", avatar: "RM", points: 3210, medal: null, highlight: false },
];
