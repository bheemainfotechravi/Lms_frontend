...
export const NAV_ITEMS = [
  { icon: MdOutlineCategory, label: "Category", path: "/admin" },
];

export const STATS = [
  { label: "Total Users", value: "50,284", change: "+12%", up: true, icon: "👥", color: "text-violet-600", bg: "bg-violet-50", border: "border-violet-100", shadow: "hover:shadow-violet-200" },
  { label: "Active Courses", value: "1,247", change: "+8%", up: true, icon: "📚", color: "text-cyan-600", bg: "bg-cyan-50", border: "border-cyan-100", shadow: "hover:shadow-cyan-200" },
  { label: "Pending Approvals", value: "23", change: "Urgent", up: false, icon: "⏳", color: "text-amber-600", bg: "bg-amber-50", border: "border-amber-100", shadow: "hover:shadow-amber-200" },
  { label: "Monthly Revenue", value: "₹4.2L", change: "+22%", up: true, icon: "💰", color: "text-emerald-600", bg: "bg-emerald-50", border: "border-emerald-100", shadow: "hover:shadow-emerald-200" },
];
...
export const ACTIVITY = [
  { icon: "👤", text: "New user registered", sub: "ankit@gmail.com", time: "2 min ago" },
  { icon: "📚", text: "Course submitted for review", sub: "Advanced Python for ML", time: "15 min ago" },
  { icon: "✅", text: "Course approved", sub: "React Bootcamp 2025", time: "1h ago" },
  { icon: "🚫", text: "User account blocked", sub: "dev@gmail.com", time: "2h ago" },
];
